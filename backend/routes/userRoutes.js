...
import { becomeHybrid, getMyAccount, getMyProfileInformation, updateMyAccount, updateMyProfileInformation, uploadAvatar as uploadAvatarController } from "../controllers/userController.js";
import { protect } from "../middleware/authMiddleware.js";
import uploadAvatar from "../middleware/uploadAvatar.js";
import { deleteAvatar, getMyShowcase, toggleDisplayAchievement } from "../controllers/userController.js";
...
router.post("/information/avatar", protect, uploadAvatar.single("avatar"), uploadAvatarController);
router.delete("/information/avatar", protect, deleteAvatar);
router.get("/showcase", protect, getMyShowcase);
router.patch("/showcase/display-achievement", protect, toggleDisplayAchievement);
